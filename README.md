...
<p>In the directory there is a environment.yml file which creates an environment called "opaws_env".  Create the enviroment using conda, "conda env create -f environment.yml" <\p>
